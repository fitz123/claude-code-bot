...
WORKSPACES=(
    "/Users/ninja/.minime/workspace"
    "/Users/ninja/.minime/workspace-coder"
)
```
...
MAIN_WORKSPACE="/Users/ninja/.minime/workspace"
CODER_WORKSPACE="/Users/ninja/.minime/workspace-coder"
...
```bash
WORKSPACE="${1:-/Users/ninja/.minime/workspace}"
```
...
SKILL.md uses absolute paths like `/Users/ninja/.minime/workspace/.claude/skills/workspace-health/scripts/size-audit.sh`. Claude Code provides `${CLAUDE_SKILL_DIR}` variable that resolves to the skill directory — scripts should use this instead.
