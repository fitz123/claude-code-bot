...
- [x] No `/Users/ninja/` string appears in any `.ts` or `.sh` file under `src/` or `scripts/`
...
- [x] `env.HOME = "/Users/ninja"` in cli-capabilities.ts (2 occurrences: detectCapabilities + verifyAuth) replaced with `os.homedir()`
- [x] `env.HOME = "/Users/ninja"` in cron-runner.ts:132 (runClaude) replaced with `os.homedir()`
...
- [x] No real Telegram user ID (306600687, 7418988410, 1320328600) in any test file
- [x] No `/Users/ninja/` path in any test file
- [x] No personal name labels ("Ninja DM", "Yulia DM", "Anna DM") in any test file
